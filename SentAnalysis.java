...
public class SentAnalysis {
	...
	public static double positiveProduct (String text) {
		...
		// For every word (feature) f, calculate log(Pr(f|Positive))
		for (String word : textArr) {
			if (!word.equals("")){
				...
				double probWordGivenPos = (positiveFreq + LAMBDA) / (totalPosWords + textArr.length*LAMBDA);
	...
	public static double negativeProduct (String text) {
		...
		// For every word (feature) f, calculate log(Pr(f|Negative))
		for (String word : textArr) {
			if (!word.equals("")){
